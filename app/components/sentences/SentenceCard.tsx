            ...
            {currentQuestion.isCorrect ? (
              <div className="flex items-center justify-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-emerald-300/70 text-sm">Excellent!</div>
                </div>
              </div>
            ) : (
              <div>
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-red-300/70 text-sm">Not quite...</div>
                  </div>
                </div>
          ...
          <div className="text-center mb-6">
            ...
            {showHint && (
              <div className="mt-3 p-4 bg-slate-900/50 rounded-xl border border-slate-700 inline-block">
                <div className="text-slate-400 text-sm mb-1">First letter:</div>
