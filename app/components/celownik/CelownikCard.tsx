...
export default function CelownikCard({
  currentQuestion,
  onAnswerChange,
  onCheckAnswer,
  onNextQuestion,
  ...
  const rule = dativeRules[currentQuestion.sentence.gender];
