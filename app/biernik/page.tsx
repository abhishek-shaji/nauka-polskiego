      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="pb-4 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold text-center bg-gradient-to-r from-rose-300 via-pink-200 to-rose-300 bg-clip-text text-transparent tracking-tight">
              Biernik
            </h2>
            <p className="text-slate-400 text-center mt-2 text-lg tracking-wide">
              Accusative Case Practice — Kogo? Co?
            </p>
            ...
            <div className="flex justify-center gap-4 mt-4 flex-wrap">
              ...
              <span className="px-4 py-2 bg-rose-600/30 border border-rose-500/50 rounded-xl text-rose-300 text-sm">
                Biernik Practice
              </span>
              <Link
                href="/sentences"
